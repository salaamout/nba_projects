...
async function loadLeaderboard() {
  ...
  try {
    ...
    tbody.innerHTML = "";
    if (!rows.length) {
      tbody.innerHTML = '<tr><td colspan="3" style="text-align:center;color:#8b949e;">No data yet</td></tr>';
      return;
    }
    rows.forEach((r, i) => {
    ...
    tbody.innerHTML = `<tr><td colspan="3" style="color:#f85149;">Error: ${esc(e.message)}</td></tr>`;
  }
}
